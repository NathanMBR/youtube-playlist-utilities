export const GITHUB_REPOSITORY_URL="https://github.com/NathanMBR/youtube-playlist-utilities";
export const GOOGLE_OAUTH_BASE_URL="https://accounts.google.com/o/oauth2/v2/auth";
export const GOOGLE_OAUTH_REDIRECT_URL_NAVIGATOR="http://localhost:1420/auth/callback";
export const GOOGLE_OAUTH_REDIRECT_URL_RUST="http://localhost:4172/auth/callback/rust";
